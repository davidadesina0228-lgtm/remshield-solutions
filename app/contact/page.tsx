...
const serviceMeta: Record<string, { title: string; badge: string; heading: string; subheading: string; accentColor: string; accentRgb: string }> = {
  "ai-systems": {
    ...
    badge: "AI Systems",
    heading: "Stop Losing Customers to Slow Response Times",
    subheading: "Tell us what's not getting answered fast enough — leads, support tickets, customer questions. We'll design the AI system that responds for you, day or night.",
    accentColor: "#00D4C8",
    accentRgb: "0,212,200",
  },
  "automation-infrastructure": {
    ...
    heading: "Get Your Team's Time Back",
    subheading: "Tell us what's eating your team's hours — manual data entry, status chasing, tools that don't talk to each other. We'll build the automation that handles it without anyone touching it.",
    accentColor: "#00AAFF",
    accentRgb: "0,170,255",
  },
  "custom-software": {
    ...
    subheading: "Tell us what you're bending your business around today — a clunky spreadsheet, a tool that almost fits. We'll design and ship software built for your actual process.",
    accentColor: "#00D4C8",
    accentRgb: "0,212,200",
  },
  "ai-discoverability": {
...
const defaultMeta = {
  ...
  heading: "Let's Find What's Fixable",
  subheading: "Tell us what's slowing your business down — even vaguely. We'll show you exactly what's solvable and build the fix around it.",
  accentColor: "#00D4C8",
  accentRgb: "0,212,200",
};
